...
class TestTeamModels(TestCase):
    ...
    def test_team_member_creation(self):
        ...
        assert self.team_member.short_bio == "An experienced software engineer specializing in web development."
...
class TestTeamSerializers(TestCase):
    ...
    def test_team_member_serializer_contains_expected_fields(self):
        ...
        expected_fields = {
            "id", "name", "role", "short_bio", "avatar", 
            "avatar_url", "display_order", "social_links"
        }
        assert set(data.keys()) == expected_fields
...
class TestTeamMemberListView(APITestCase):
    ...
    def test_get_team_members_includes_social_links(self):
        ...
        bob_data = next((member for member in data if member["name"] == "Bob Wilson"), None)
